        ...
        <View style={{ justifyContent: 'center', alignContent: 'center' }}>
          ...
          <Text
            ...
            <View style={{ justifyContent: 'space-around', alignContent: 'center' }}>
                ...
                <View>
                    <Text style={styles.section_heading3}> Feedback Question </Text>
                ...
                <View>
                    <TextInput style={{ width: 348, borderRadius: 8, borderWidth: 0.2, backgroundColor: '#FFFFFF', marginLeft: 15, paddingBottom: 120,marginTop:35}}
                ...
                <View style={{ width: "100%", paddingTop: 15, flexDirection: 'row' }}>
                    <Text style={styles.section_heading4}>Status</Text>
