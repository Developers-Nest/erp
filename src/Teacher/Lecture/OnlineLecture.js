...
export default function OnlineLecture()
{
    ...
    <Card.Content>
      ...
      <View
       ...
       style={{
        ...
        />
         ...
         />
         <View style={{flexDirection:'row',paddingVertical:70,alignSelf:'center'}}>
    
         <List.Item style={{width:125,borderWidth:0.3,borderTopRightRadius:5,borderBottomRightRadius:5,borderBottomLeftRadius:5,borderTopLeftRadius:5}}
          title="Date"
         ...
         <TouchableOpacity  onPress={()=>{}}>
         <List.Item style={{width:100,borderWidth:0.3,alignContent:'center',borderTopRightRadius:5,borderBottomRightRadius:5,borderBottomLeftRadius:5,borderTopLeftRadius:5}}
          title="Add Link"
         />
         </TouchableOpacity>
     </View>
      ...
      <Text style={{fontSize:17,fontFamily:'Poppins-Regular',paddingLeft:15,marginTop:15}}>
          Reccurence Days
      </Text>
